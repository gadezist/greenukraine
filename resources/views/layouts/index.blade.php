   ...
   <head>
      ...
      <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script><![endif]-->
       ...
       @vite([
               ...
               'resources/js/app.js',
               'resources/js/main_layout/jquery.min.js',
               "resources/js/main_layout/bootstrap.bundle.min.js",
               "resources/js/main_layout/jquery-3.0.0.min.js",
               "resources/js/main_layout/custom.js",
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="{{ route('map') }}">About</a>
                              </li>
                              <li class="nav-item">
                                  <a class="nav-link" href="{{ route('partners') }}">What we do</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="{{ route('actual') }}">Portfolio </a>
                              </li>
                              <li class="nav-item">
